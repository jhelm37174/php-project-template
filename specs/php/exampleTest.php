...
class exampleFunction extends PHPUnit_Framework_TestCase
{
  ...
  {
    $this->assertTrue(exampleFunction(1,2,3) == 6);
  }

  public function test_exampleFunction2()
  {
    $this->assertTrue(exampleFunction(5,5,5) == 15);
  }

  public function test_exampleFunction3()
  {
